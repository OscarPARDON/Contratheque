...
<header class="fixed-top bg-white" >
  ...
  <!-- Partie Haute -->
  <div class="shadow-sm py-3 mb-1 d-flex align-items-center" style="padding: 0 3rem; position: relative;">

    <!-- Service actuellement séléctionné par l'utilisateur -->
    ...
    <div class="dropdown show" style="position: absolute; right: 3rem;">
      <a href="index.php?route=logout">
        <img src="templates/images/logout.svg" alt="Se déconnecter" style="width:50px">
      </a>
    </div>
  ...
  <!-- Partie Basse -->
  <div class="bg-light d-flex justify-content-around py-2 shadow-sm">

    <!-- Dropdown N°1 : Contrats -->
    <div class="dropdown show">

      <a class="text-decoration-none font-weight-bold text-dark dropdown-toggle py-3" href="#"  data-toggle="dropdown"> Contrats </a>
    ...
    <div class="dropdown show">
      ...
      <a class="text-decoration-none font-weight-bold text-dark dropdown-toggle py-3" href="#" data-toggle="dropdown"> Aide </a>
...
<!-- ########################################################################################################################################## -->
<!-- CSS pour le déclanchement des Dropdowns quand souris hover --> 
<style>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.dropdown').forEach(dropdown => {
      ...
      // Ignorer les dropdowns qui n'ont pas de menu
      if (!menu) return;
